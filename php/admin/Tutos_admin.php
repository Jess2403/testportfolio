...
<div class="div1">
    ...
    <h2>Vidéo YouTube</h2>
    <p>Nous allons voir dans cette vidéo comment créer une base de données avec php myAdmin!</p>
    ...
    <p>J'ai choisi cette vidéo car elle est courte simple et pratique. Elle nous apprends comment télécharger un serveur comme Wampserver, car sans serveur nous ne pouvons pas créer de base de données pour nos sites internet</p>
    ...
    <p>Dans ce tuto, je vais vous guider pour faire une base de données avec php myAdmin.</p><br>
    ...
    <p>Ensuite vous devez ouvrir wamp, activez les services en cliquant droit sur l'icône qui se trouvera dans votre barre des
        tâches, dans le menu appuyez sur activer les services, quand il passe de rouge à vert, ça y est les services sont activés.</p>
    ...
    <p>Quand vous êtes sur la page d'accueil pour vous connectez il faut mettre le mot "root" dans "Utilisateur", ne mettez pas de mot de passe
    ...
    <div class="div2">
        <ol class="liste2">
            <li>Vous cliquez sur "Créez une nouvelle base de données" en lui donnant un nom et le nombre de colonnes que vous voulez. Puis exécutez.</li><br>
            <li>Vous verrez dans les champs à gauche que vous avez créé une nouvelle table ave le nom que vous lui aurez donné.</li><br>
            <li>Vous pouvez à présent donner des noms à vos colonnes en général vous pouvez commencer par la colonne "id" puis nom par ewemple,
                ...
                et pourra ête inscrit dans la base de données automatiquement dans votre base de données lors de leur enregistrement. Puis Enregistrez</li><br>
            <li>Vous pouvez faire autant de colonnes que vous voulez.</li><br>
            <li>Après avoir enregistré votre base de données si vous allez sur parcourir, vous verrez tout vos noms de colonnes les une à côtés des autres.</li>
